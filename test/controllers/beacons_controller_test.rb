...
class BeaconsControllerTest < ActionController::TestCase
  ...
  test "should create beacon" do
    assert_difference('Beacon.count') do
      post :create, beacon: { UUID: @beacon.UUID, location: @beacon.location, major: @beacon.major, minor: @beacon.minor }
    end
  ...
  test "should update beacon" do
    patch :update, id: @beacon, beacon: { UUID: @beacon.UUID, location: @beacon.location, major: @beacon.major, minor: @beacon.minor }
    assert_redirected_to beacon_path(assigns(:beacon))
  end
